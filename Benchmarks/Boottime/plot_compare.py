...
def create_plot(categories, output_dir, y_scale='linear', motivation=False):
    ...
    plt.savefig(output_dir / f'{plot_type}boot_time_opt_{y_scale}.pdf', format='pdf', dpi=300, bbox_inches='tight')
    plt.savefig(output_dir / f'{plot_type}boot_time_opt_{y_scale}.png', format='png', dpi=300, bbox_inches='tight')
